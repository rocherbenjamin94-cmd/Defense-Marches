...
export default function Dashboard() {
    ...
    const counts = useMemo(() => {
        const c: Partial<Record<FilterType, number>> = {
            all: tenders.length,
            urgent: filterTenders(tenders, 'urgent').length,
            armees: filterTenders(tenders, 'armees').length,
            terre: filterTenders(tenders, 'terre').length,
            marine: filterTenders(tenders, 'marine').length,
            air: filterTenders(tenders, 'air').length,
            interieur: filterTenders(tenders, 'interieur').length,
            dga: filterTenders(tenders, 'dga').length,
            joue: filterTenders(tenders, 'joue').length,
